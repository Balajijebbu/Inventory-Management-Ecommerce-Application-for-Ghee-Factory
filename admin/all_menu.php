        ...
        <img src="images/uma ghee logo.png" alt="homepage" class="dark-logo" style="max-height: 80px;max-width: 100px; margin-right: 70px;" />
                                ...
                                <div class="navbar-collapse">
                                    ...
                                    <ul class="navbar-nav my-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/uma ghee logo.png" alt="user" class="profile-pic" /></a>
...
<?php
                        $sql = "SELECT title, slogan, price, img, d_id FROM dishes ORDER BY d_id DESC";
