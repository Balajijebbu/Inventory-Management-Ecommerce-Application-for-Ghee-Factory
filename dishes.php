...
<body>
    ...
    <div class="page-wrapper">
        <div class="top-links">
            <div class="container">
                <ul class="row links"><br>

                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="#">Choose Product</a></li>
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite Product</a></li>
