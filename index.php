...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark"style="background-image: none;">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/uma ghee logo.png" alt="" width="110"height="50px"> </a>
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item"> <a class="nav-link active" href="index-full.html">Home <span class="sr-only">(current)</span></a> </li>
    ...
    <section class="hero bg-image" data-image-src="images/img/Ghee1.jpg">
            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose Product</h4>
                    </div>
                    <!--  Author Name: MH RONY.
                        GigHub Link: https://github.com/dev-mhrony
                        Facebook Link:https://www.facebook.com/dev.mhrony
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Order Ghee</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Variety Of Ghee Products</h2>
                <p class="lead">Experience the rich and aromatic flavors of premium ghee, adding depth and richness to a variety of dishes.</p>
            </div>
            <div class="row">
                <!--  Author Name: MH RONY.
                        GigHub Link: https://github.com/dev-mhrony
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We"ve got your covered with menus from a variety of Ghee.</p>
                            </div>
                        </div>
                    </div>
                    <!--  Author Name: MH RONY.
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                        <div class="step step-2">
                            ...
                            <h3>Choose a Variety</h3>
                            <p>We"ve got your covered with a variety of Ghee.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <p>Get your Ghee delivered! And enjoy your Day! </p>
                        </div>
                    </div>
                </div>
            </div>
